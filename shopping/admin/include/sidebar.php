...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="seller_applications.php"><i class="menu-icon icon-table"></i>Approve Sellers </a></li>
                                <li><a href="approved_sellers.php"><i class="menu-icon icon-table"></i> Sellers </a></li>
